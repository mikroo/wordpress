...
<div id="comments" class="comments-area<?php if ( get_theme_mod('seasun_next_preview_post', seasun_default_options('seasun_next_preview_post')) == 'Display' || get_theme_mod('seasun_next_preview_post', seasun_default_options('seasun_next_preview_post')) == '' ) { ?> comments-area-post<?php } ?>">
